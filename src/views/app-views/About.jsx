...
const About = () => {
    ...
    return (
        <div className="bg-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-20 mt-20">
        {compañeros.map(compañero => (
          <div className="m-8 w-4/5 bg-secondary border border-secondaryBorder shadow-md rounded-2xl " key={compañero.id}>
            <img className="w-5/6 m-8 rounded-full  mx-auto" src={compañero.foto} alt={compañero.nombre} />
            <h3 className="text-lg text-blue-500 font-semibold">{compañero.nombre}</h3>
            <p className="text-gray-600 mb-2">{compañero.correo}</p>
            <p className="text-gray-600 mb-4">{compañero.telefono}</p>
            <p>
              <a className="text-blue-500 hover:text-blue-600" href={compañero.github}>Github</a>
            </p>
            <p>
              <a className="text-blue-500 hover:text-blue-600" href={compañero.linkedin}>LinkedIn</a>
            </p>
          </div>
        ))}
      </div>
