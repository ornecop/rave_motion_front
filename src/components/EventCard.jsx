...
export const EventCard = ({ id, name, image, date, venue, hour }) => {
    ...
    return (
        <div className="h-[21.5rem] w-48 bg-secondary rounded-xl border border-secondaryBorder">
            ...
            <div className="mx-2 my-2">
                <div className="flex flex-row h-16 pb-2 border-b border-secondaryBorder">
